...
class SubstitutionPlanFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val substitutions = listOf(
            ...
            Substitution(8, arrayOf(Course("091c", null, "9c")), arrayOf(5,6), Subject.POLITICS_ECONOMICS, "007", Subject.POLITICS_ECONOMICS, "202", SubstitutionType.ROOM_CHANGE, ""),
            ...
            Substitution(12, arrayOf(Course("E1/2", "l07", "E1/2(l07)")), arrayOf(3,4), Subject.LATIN, "M5", Subject.CANCELED, "---", SubstitutionType.CANCELED, ""),
            Substitution(13, arrayOf(Course("E1/2", "d07", "E1/2(d07)")), arrayOf(5), Subject.GERMAN, "D4", Subject.CANCELED, "---", SubstitutionType.CANCELED, ""),
            ...
            Substitution(15, arrayOf(Course("Q1/2", "ph05", "Q1/2(ph05)")), arrayOf(6), Subject.PHYSICS, "P3", Subject.CANCELED, "---", SubstitutionType.CANCELED, ""),
            Substitution(16, arrayOf(Course("Q3/4", "E01", "Q3/4(E01)")), arrayOf(3,4), Subject.ENGLISH, "112", Subject.CANCELED, "---", SubstitutionType.CANCELED, "Aufgaben sind in Moodle gestellt"),
